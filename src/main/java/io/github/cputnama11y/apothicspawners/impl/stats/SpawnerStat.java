...
public interface SpawnerStat<T> {
     ...
     */
    T getValue(SpawnerBlockEntity spawner);

    /**
     * Sets the current value of this stat.
     */
    void setValue(SpawnerBlockEntity spawner, T value);
     ...
     */
    Component getTooltip(SpawnerBlockEntity spawner);
     ...
     */
    boolean applyModifier(SpawnerBlockEntity spawner, T value, Optional<T> min, Optional<T> max);
