package io.github.cputnama11y.apothicspawners.impl.modifier;

import com.google.common.collect.ImmutableList;
import io.github.cputnama11y.apothicspawners.impl.ApothicAttachments;
import io.github.cputnama11y.apothicspawners.impl.util.LessSimpleJsonResourceReloadListener;
...
public class ModifierLoader extends LessSimpleJsonResourceReloadListener<SpawnerModifier> {
    ...
    protected void apply(Map<Identifier, SpawnerModifier> object, ResourceManager resourceManager, ProfilerFiller profilerFiller, SharedState sharedState) {
        ...
        if (SERVER != null) {
            ...
            SERVER.getAllLevels().forEach(it -> it.setAttached(ApothicAttachments.MODIFIERS, immutable));
        }
