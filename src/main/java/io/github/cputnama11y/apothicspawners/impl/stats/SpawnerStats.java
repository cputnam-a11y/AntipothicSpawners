package io.github.cputnama11y.apothicspawners.impl.stats;
...
//    public static final SpawnerStat<Integer> SPAWN_RANGE = register("spawn_range", new VanillaStat(s -> s.spawner.spawnRange, (s, v) -> s.spawner.spawnRange = v));
    // TODO: Wire
    public static final SpawnerStat<Float> INITIAL_HEALTH = register("initial_health", new PercentageStat(1F, ApothicAttachments.INITIAL_HEALTH));

    public static final SpawnerStat<Boolean> IGNORE_PLAYERS = register("ignore_players", new BooleanStat(false, ApothicAttachments.IGNORE_PLAYERS));
    // TODO: Wire
    public static final SpawnerStat<Boolean> IGNORE_CONDITIONS = register("ignore_conditions", new BooleanStat(false, ApothicAttachments.IGNORE_CONDITIONS));

    public static final SpawnerStat<Boolean> REDSTONE_CONTROL = register("redstone_control", new BooleanStat(false, ApothicAttachments.REDSTONE_CONTROL));
    // TODO: Wire
    public static final SpawnerStat<Boolean> IGNORE_LIGHT = register("ignore_light", new BooleanStat(false, ApothicAttachments.IGNORE_LIGHT));
    // TODO: Wire
    public static final SpawnerStat<Boolean> NO_AI = register("no_ai", new BooleanStat(false, ApothicAttachments.NO_AI));
    // TODO: Wire
    public static final SpawnerStat<Boolean> SILENT = register("silent", new BooleanStat(false, ApothicAttachments.SILENT));
    // TODO: Wire
    public static final SpawnerStat<Boolean> YOUTHFUL = register("youthful", new BooleanStat(false, ApothicAttachments.YOUTHFUL));
    // TODO: Wire
    public static final SpawnerStat<Boolean> BURNING = register("burning", new BooleanStat(false, ApothicAttachments.BURNING));
    // TODO: Wire
    public static final SpawnerStat<Integer> ECHOING = register("echoing", new LevelStat(0, ApothicAttachments.ECHOING));
